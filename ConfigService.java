...
public class ConfigService {
    ...
    private Properties buildConsumerProperties(Map<String, Object> config) {
     ...
     //   consumerProps.put(org.apache.kafka.clients.consumer.ConsumerConfig.HEARTBEAT_INTERVAL_MS_CONFIG, heartbeatIntervalMs);
        consumerProps.put(org.apache.kafka.clients.consumer.ConsumerConfig.MAX_POLL_INTERVAL_MS_CONFIG, maxPollIntervalMs);

        // props.put(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG, "lkc-38zyqm-g30jdg.eastus2.azure.glb.confluent.cloud:9092");
